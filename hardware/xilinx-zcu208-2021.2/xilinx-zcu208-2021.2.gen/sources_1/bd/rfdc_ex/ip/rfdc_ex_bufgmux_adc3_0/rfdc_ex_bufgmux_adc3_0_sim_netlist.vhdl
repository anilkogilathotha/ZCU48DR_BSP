...
-- Command     : write_vhdl -force -mode funcsim -rename_top rfdc_ex_bufgmux_adc3_0 -prefix
--               rfdc_ex_bufgmux_adc3_0_ rfdc_ex_bufgmux_adc0_0_sim_netlist.vhdl
...
entity rfdc_ex_bufgmux_adc3_0_bufgmux is
  port (
    O : out STD_LOGIC;
    I0 : in STD_LOGIC;
    I1 : in STD_LOGIC;
...
end rfdc_ex_bufgmux_adc3_0_bufgmux;

architecture STRUCTURE of rfdc_ex_bufgmux_adc3_0_bufgmux is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rfdc_ex_bufgmux_adc3_0 is
  port (
    I0 : in STD_LOGIC;
    I1 : in STD_LOGIC;
    S : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of rfdc_ex_bufgmux_adc3_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of rfdc_ex_bufgmux_adc3_0 : entity is "rfdc_ex_bufgmux_adc0_0,bufgmux,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of rfdc_ex_bufgmux_adc3_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of rfdc_ex_bufgmux_adc3_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of rfdc_ex_bufgmux_adc3_0 : entity is "bufgmux,Vivado 2021.2";
end rfdc_ex_bufgmux_adc3_0;

architecture STRUCTURE of rfdc_ex_bufgmux_adc3_0 is
...
begin
inst: entity work.rfdc_ex_bufgmux_adc3_0_bufgmux
     port map (
      I0 => I0,
      I1 => I1,
      O => O,
