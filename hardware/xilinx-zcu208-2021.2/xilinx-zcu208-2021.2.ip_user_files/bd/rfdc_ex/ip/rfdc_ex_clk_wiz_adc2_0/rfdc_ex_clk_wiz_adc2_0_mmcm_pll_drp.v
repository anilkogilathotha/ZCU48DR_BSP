...
module rfdc_ex_clk_wiz_adc2_0_pll_drp
   ...
   `include "mmcm_pll_drp_func_us_plus_pll.vh"
   ...
   localparam [9:0]  S1_DIGITAL_FILT   = 
      mmcm_pll_filter_lookup(S1_CLKFBOUT_MULT);
   ...
   wire [9:0] S2_DIGITAL_FILT    = 
      mmcm_pll_filter_lookup(S2_CLKFBOUT_MULT);
   ...
   initial begin
      ...
      ram[0]  <= {7'h08, 16'h1000, S1_CLKOUT0[15:0]};
      ram[1]  <= {7'h09, 16'h8000, S1_CLKOUT0[31:16]};
					
      // Store CLKOUT1 divide and phase
      ram[2]  <= {7'h0A, 16'h1000, S1_CLKOUT1[15:0]};
      ram[3]  <= {7'h0B, 16'h9C00, S1_CLKOUT1[31], 2'b11 , S1_CLKOUT1[28:16]};//Clocking Wizard doesn't support CLKOUTPHY_MODE
      
      // Store the input divider
      ram[4] <= {7'h16, 16'hC000, {2'h0, S1_DIVCLK[23:22], S1_DIVCLK[11:0]} };
      
      // Store the feedback divide and phase
      ram[5] <= {7'h14, 16'h1000, S1_CLKFBOUT[15:0]};
      ram[6] <= {7'h15, 16'h8000, S1_CLKFBOUT[31:16]};
    
      // Store the lock settings
      ram[7] <= {7'h18, 16'hFC00, {6'h00, S1_LOCK[29:20]} };
      ram[8] <= {7'h19, 16'h8000, {1'b0 , S1_LOCK[34:30], S1_LOCK[9:0]} };
      ram[9] <= {7'h1A, 16'h8000, {1'b0 , S1_LOCK[39:35], S1_LOCK[19:10]} };
      
      // Store the filter settings
      ram[10] <= {7'h4E, 16'h0000, 
                S1_DIGITAL_FILT[9], 2'h0, S1_DIGITAL_FILT[8:7], 2'h0, 
                S1_DIGITAL_FILT[6], 8'h00 };
      ram[11] <= {7'h4F, 16'h666F, 
   ...
   if (LOAD) begin 
      // Store CLKOUT0 divide and phase
      ram[12] <= {7'h08, 16'h1000, S2_CLKOUT0[15:0]};
      ram[13] <= {7'h09, 16'h8000, S2_CLKOUT0[31:16]};
      
      // Store CLKOUT1 divide and phase
      ram[14] <= {7'h0A, 16'h1000, S2_CLKOUT1[15:0]};
      ram[15]  <= {7'h0B, 16'h9C00, S2_CLKOUT1[31], 2'b11 , S2_CLKOUT1[28:16]};//Clocking Wizard doesn't support CLKOUTPHY_MODE
     
      // Store the input divider
      ram[16] <= {7'h16, 16'hC000, {2'h0, S2_DIVCLK[23:22], S2_DIVCLK[11:0]} };
      
      // Store the feedback divide and phase
      ram[17] <= {7'h14, 16'h1000, S2_CLKFBOUT[15:0]};
      ram[18] <= {7'h15, 16'h8000, S2_CLKFBOUT[31:16]};
      
      // Store the lock settings
      ram[19] <= {7'h18, 16'hFC00, {6'h00, S2_LOCK[29:20]} };
      ram[20] <= {7'h19, 16'h8000, {1'b0 , S2_LOCK[34:30], S2_LOCK[9:0]} };
      ram[21] <= {7'h1A, 16'h8000, {1'b0 , S2_LOCK[39:35], S2_LOCK[19:10]} };
      
      // Store the filter settings
      ram[22] <= {7'h4E, 16'h0000, 
                S2_DIGITAL_FILT[9], 2'h0, S2_DIGITAL_FILT[8:7], 2'h0, 
                S2_DIGITAL_FILT[6], 8'h00 };
      ram[23] <= {7'h4F, 16'h666F, 
